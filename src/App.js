...
export default class Component extends React.Component {
  ...
  handleSavePng = () => {
    toPng(document.getElementById("medalion")).then(function (dataUrl) {
          ...
          >
            ...
            <div>
              <div
                ...
                onClick={() =>
                  this.setState({
                    displayColorPickerGradient: !this.state
              ...
              {this.state.displayColorPickerGradient ? (
                <div
                  style={{
                    position: "absolute",
                    zIndex: "2"
                ...
                >
                  ...
                  />
                  <SketchPicker
                    color={this.state.medalionColor}
                    onChange={(color) =>
          ...
          >
            ...
            <div>
              <div
                ...
                onClick={() =>
                  this.setState({
                    displayColorPickerBorder: !this.state
              ...
              {this.state.displayColorPickerBorder ? (
                <div
                  style={{
                    position: "absolute",
                    zIndex: "2"
